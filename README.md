...
This is a very lightweight, custom built image viewer written entirely in raw C. This program parses raw binary data from a P6 `.ppm` image file and renders the pixels to the screen using the SDL2 graphics framework.
